...
class MigrationMapper:
    ...
    def convert_governance_to_yaml(self, governance_json: Dict[str, Any]) -> Dict[str, Any]:
        ...
        governance_v3 = {
            ...
            'enforcement': {
                ...
                'on_violation': {
                    'pre_commit': 'block' if policies.get('enforce_full_file_output', False) else 'warn',
                    'pre_push': 'block',
                },
        ...
        if inline_policy:
            governance_v3['policies'] = {
                ...
                'full_file_output': {
                    ...
                    'description': policies.get('full_file_output_policy', {}).get('description', ''),
                }
            }
    ...
    def merge_hrpo_features(self, existing_features: List[Dict[str, Any]],
                           hrpo_features: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
