...
class AdaptivePlanner:
    ...
    def regenerate_tasks(self, event: PRDChangeEvent) -> RegenerationResult:
        ...
        for feature_id in event.affected_features:
            self._feature_task_map[feature_id] = {t.id for t in new_tasks if t.feature_id == feature_id}
...
def get_adaptive_planner(project_root: Optional[Path] = None, task_queue: Optional[TaskQueue] = None) -> AdaptivePlanner:
