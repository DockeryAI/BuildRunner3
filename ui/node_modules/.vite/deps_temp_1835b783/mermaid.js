...
import {
  selectSvgElement
} from "./chunk-RMAXC43W.js";
import {
  JSON_SCHEMA,
  load
} from "./chunk-UM67L44S.js";
import {
  registerLayoutLoaders
} from "./chunk-P7VMLDIF.js";
import "./chunk-ZJDP6SQ2.js";
import "./chunk-TFXWV2M2.js";
import "./chunk-27QMQUPF.js";
import "./chunk-EL63ITJI.js";
import "./chunk-HWTKHREM.js";
import {
  dedent,
  registerIconPacks
} from "./chunk-G5EQ4UNK.js";
import {
  cleanAndMerge,
  decodeEntities,
  encodeEntities,
...
import {
  ...
  themes_default,
  updateSiteConfig
} from "./chunk-AHNHLFIV.js";
import {
  __name,
  log,
  select_default,
  setLogLevel
} from "./chunk-W6H3EFY5.js";
import {
  isEmpty_default
...
var loader = __name(async () => {
  const { diagram: diagram2 } = await import("./c4Diagram-YG6GDRKO-OHDOM4FS.js");
...
var loader2 = __name(async () => {
  const { diagram: diagram2 } = await import("./flowDiagram-NV44I4VS-J4JW62LZ.js");
...
var loader4 = __name(async () => {
  const { diagram: diagram2 } = await import("./erDiagram-Q2GNP2WA-7RW44JZQ.js");
...
var loader5 = __name(async () => {
  const { diagram: diagram2 } = await import("./gitGraphDiagram-NY62KEGX-AGQVAXPT.js");
...
var loader6 = __name(async () => {
  const { diagram: diagram2 } = await import("./ganttDiagram-LVOFAZNH-WVX3OMWT.js");
...
var loader7 = __name(async () => {
  const { diagram: diagram2 } = await import("./infoDiagram-ER5ION4S-LSHLMMTJ.js");
...
var loader8 = __name(async () => {
  const { diagram: diagram2 } = await import("./pieDiagram-ADFJNKIX-NNM4ZKPU.js");
...
var loader9 = __name(async () => {
  const { diagram: diagram2 } = await import("./quadrantDiagram-AYHSOK5B-VAM5GZ77.js");
...
var loader10 = __name(async () => {
  const { diagram: diagram2 } = await import("./xychartDiagram-PRI3JC2R-W4FFNJCO.js");
...
var loader11 = __name(async () => {
  const { diagram: diagram2 } = await import("./requirementDiagram-UZGBJVZJ-4MHECLPF.js");
...
var loader12 = __name(async () => {
  const { diagram: diagram2 } = await import("./sequenceDiagram-WL72ISMW-5LLIDMCU.js");
...
var loader13 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-2ON5EDUG-Y7E4LFCT.js");
...
var loader14 = __name(async () => {
  const { diagram: diagram2 } = await import("./classDiagram-v2-WZHVMYZB-7KOBYBRB.js");
...
var loader15 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-FKZM4ZOC-3ONMZX7V.js");
...
var loader16 = __name(async () => {
  const { diagram: diagram2 } = await import("./stateDiagram-v2-4FDKWEC3-BZ2VFYQV.js");
...
var loader17 = __name(async () => {
  const { diagram: diagram2 } = await import("./journeyDiagram-XKPGCS4Q-WO7OXIDF.js");
...
var loader19 = __name(async () => {
  const { diagram: diagram2 } = await import("./timeline-definition-IT6M3QCI-KRU2XE3X.js");
...
var loader20 = __name(async () => {
  const { diagram: diagram2 } = await import("./mindmap-definition-VGOIOE7T-GP3H5DM3.js");
...
var loader21 = __name(async () => {
  const { diagram: diagram2 } = await import("./kanban-definition-3W4ZIXB7-CTCNVES4.js");
...
var loader22 = __name(async () => {
  const { diagram: diagram2 } = await import("./sankeyDiagram-TZEHDZUN-AY2PXB3P.js");
...
var loader23 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-S2PKOQOG-ZNC3JN5V.js");
...
var loader24 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-QEK2KX5R-WARKGAUC.js");
...
var loader25 = __name(async () => {
  const { diagram: diagram2 } = await import("./blockDiagram-VD42YOAC-7DWL5WLA.js");
...
var loader26 = __name(async () => {
  const { diagram: diagram2 } = await import("./architectureDiagram-VXUJARFQ-V36JWB2N.js");
...
var loader27 = __name(async () => {
  const { diagram: diagram2 } = await import("./diagram-PSM6KHXK-MRM74TJW.js");
