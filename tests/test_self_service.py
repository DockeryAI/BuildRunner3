...
from core.self_service import SelfServiceManager, ServiceRequirement, SERVICE_PATTERNS
...
"""
    ...
    def test_check_environment_configured(
        self, manager, tmp_path, sample_stripe_code, sample_env_content
    ):
...
class TestEnvTemplateGeneration:
    ...
    def test_generate_env_template_multiple_services(
        self, manager, tmp_path, sample_stripe_code, sample_aws_code
    ):
...
class TestCredentialValidation:
    ...
    def test_validate_openai_correct_format(self, manager):
        ...
        credentials = {"OPENAI_API_KEY": "sk-1234567890abcdef1234567890abcdef"}
...
class TestServiceSetup:
    ...
    def test_update_env_file(self, manager, tmp_path):
        ...
        credentials = {"NEW_VAR": "new_value", "EXISTING_VAR": "updated_value"}
