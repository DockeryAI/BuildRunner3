...
class TestGovernanceEnforcer:
    ...
    def test_validate_commit_message_invalid_format(self, enforcer_with_config):
        ...
        is_valid, error = enforcer_with_config.validate_commit_message("Added some stuff")
    ...
    def test_validate_commit_message_invalid_type(self, enforcer_with_config):
        ...
        is_valid, error = enforcer_with_config.validate_commit_message("invalid: This should fail")
    ...
    def test_validate_commit_message_no_requirement(self, temp_project):
        ...
        config = {
            "project": {"name": "Test"},
            "workflow": {"rules": {"commit_rules": {"require_semantic_versioning": False}}},
    ...
    def test_validate_branch_name_invalid(self, enforcer_with_config):
        ...
        is_valid, error = enforcer_with_config.validate_branch_name("random-branch-name")
    ...
    def test_enforce_dependency_met(self, enforcer_with_config):
        ...
        context = {
            ...
            "features_json": {"features": [{"id": "feature-a", "status": "complete"}]},
        }
    ...
    def test_enforce_dependency_not_met(self, enforcer_with_config):
        ...
        context = {
            "feature_id": "feature-b",
            "features_json": {"features": [{"id": "feature-a", "status": "in_progress"}]},
        }
    ...
    def test_enforce_warn_mode(self, enforcer_with_config, capsys):
        ...
        enforcer_with_config.governance.config["enforcement"]["on_violation"][
            "state_transition"
        ] = "warn"
