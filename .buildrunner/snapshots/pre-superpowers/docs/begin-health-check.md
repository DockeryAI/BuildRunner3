...
This document covers the code health checklist to complete before entering plan mode.
...
Output this checklist before planning. Copy the template and fill it in:
...
1. Add "Create edge function for X" as priority task
2. Must secure key before proceeding with feature
...
4. ✅ Any security fixes added as priority tasks
