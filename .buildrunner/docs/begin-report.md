...
## BUILD Completion Check (MANDATORY)

**You MUST execute this check and output the checklist BEFORE writing any final report.**
...
All [TOTAL] phases in BUILD_[name].md have been completed.
