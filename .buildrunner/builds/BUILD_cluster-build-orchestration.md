...
- [ ] Every commit triggers Walter tests + Lomax build validation (Phase 1)
- [ ] Below classifies phases, drafts commits, summarizes logs (Phase 2)
- [ ] Skills write findings back to Lockwood (Phase 3)
- [ ] `/commit` warns on failing tests/builds (Phase 4)
- [ ] Migrations dry-run on Lomax before prod (Phase 5)
- [ ] Account swap works + proactive warning (Phase 6)
- [ ] Registry tracks all builds cluster-wide (Phase 7)
- [ ] `/spec` auto-registers with node assignment (Phase 9)
- [ ] `/autopilot` dispatches to correct node (Phase 11)
- [ ] `/dash` shows cluster-wide status (Phase 13)
- [ ] Failed builds auto-analyze via Below + Lockwood (Phase 17)
- [ ] Governance checks run before every dispatch (Phase 18)
- [ ] Web dashboard with live SSE updates (Phase 26)
